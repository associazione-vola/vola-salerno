...
export default function RaccoltaFondi() {
  return (
    <section id="raccolta-fondi" className="py-20 bg-amber-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-md p-8 sm:p-12 flex flex-col items-center text-center gap-6 max-w-2xl mx-auto">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-amber-500 hover:bg-amber-400 text-white font-semibold px-8 py-3 rounded-full transition-colors text-base shadow-sm"
          >
